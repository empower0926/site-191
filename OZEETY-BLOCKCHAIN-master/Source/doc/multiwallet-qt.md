...
In order to support loading of multiple wallets in ozeety-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is ozeety.cpp.
...
Changes to ozeety.cpp
----------------------
ozeety.cpp is the entry point into ozeety-qt, and as such, will require some minor modifications to provide hooks for
