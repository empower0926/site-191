...
This mechanism has been integrated into Bitcore-Node-ozeety which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/ozeety-Project/insight-api-ozeety#web-socket-api](https://github.com/ozeety-Project/insight-api-ozeety#web-socket-api) 
* API: [https://github.com/ozeety-Project/insight-api-ozeety#swifttx-transactions](https://github.com/ozeety-Project/insight-api-ozeety#swifttx-transactions) 
...
By default, the ozeety Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the ozeety Core daemon:
