...
#   c) node1 mines 32 blocks, so now node 0 has 60001oztg, node 1 has 4250oztg, node2 has none.
#   d) node0 sends 601 oztg to node2, in two transactions (301 oztg, then 300 oztg).
