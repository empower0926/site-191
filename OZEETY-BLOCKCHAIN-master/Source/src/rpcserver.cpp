...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* ozeety features */
        {"ozeety", "masternode", &masternode, true, true, false},
        {"ozeety", "listmasternodes", &listmasternodes, true, true, false},
        {"ozeety", "getmasternodecount", &getmasternodecount, true, true, false},
        {"ozeety", "masternodeconnect", &masternodeconnect, true, true, false},
        {"ozeety", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"ozeety", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"ozeety", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"ozeety", "masternodecurrent", &masternodecurrent, true, true, false},
        {"ozeety", "masternodedebug", &masternodedebug, true, true, false},
        {"ozeety", "startmasternode", &startmasternode, true, true, false},
        {"ozeety", "createmasternodekey", &createmasternodekey, true, true, false},
        {"ozeety", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"ozeety", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"ozeety", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"ozeety", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"ozeety", "getmasternodescores", &getmasternodescores, true, true, false},
        {"ozeety", "mnbudget", &mnbudget, true, true, false},
        {"ozeety", "preparebudget", &preparebudget, true, true, false},
        {"ozeety", "submitbudget", &submitbudget, true, true, false},
        {"ozeety", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"ozeety", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"ozeety", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"ozeety", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"ozeety", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"ozeety", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"ozeety", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"ozeety", "checkbudgets", &checkbudgets, true, true, false},
        {"ozeety", "mnsync", &mnsync, true, true, false},
        {"ozeety", "spork", &spork, true, true, false},
        {"ozeety", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzoztgseed", &getzoztgseed, false, false, true},
        {"zerocoin", "setzoztgseed", &setzoztgseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzoztg", &searchdzoztg, false, false, true},
        {"zerocoin", "dzoztgstate", &dzoztgstate, false, false, true}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:8385/\n";
}
