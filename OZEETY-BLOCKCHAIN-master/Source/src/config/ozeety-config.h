/* src/config/ozeety-config.h.  Generated from ozeety-config.h.in by configure.  */
/* src/config/ozeety-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef OZTG_CONFIG_H

#define OZTG_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.ozeety.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "ozeety Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "ozeety Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "ozeety"
