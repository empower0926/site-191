...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total ozeety balance of the wallet (excluding zerocoins)\n"
            ...
            "  \"zOZTGsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zOZTG denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zOZTG denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zOZTG denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zOZTG denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zOZTG denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zOZTG denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zOZTG denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zOZTG denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zOZTG denominations\n"
            "  }\n"
    ...
    UniValue zoztgObj(UniValue::VOBJ);
    for (auto denom : libzerocoin::zerocoinDenomList) {
        zoztgObj.push_back(Pair(to_string(denom), ValueFromAmount(chainActive.Tip()->mapZerocoinSupply.at(denom) * (denom*COIN))));
    }
    zoztgObj.push_back(Pair("total", ValueFromAmount(chainActive.Tip()->GetZerocoinSupply())));
    obj.push_back(Pair("zOZTGsupply", zoztgObj));
