...
extern UniValue setzoztgseed(const UniValue& params, bool fHelp);
extern UniValue getzoztgseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzoztg(const UniValue& params, bool fHelp);
extern UniValue dzoztgstate(const UniValue& params, bool fHelp);
