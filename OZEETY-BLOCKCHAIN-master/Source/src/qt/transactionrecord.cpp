...
QList<TransactionRecord> TransactionRecord::decomposeTransaction(const CWallet* wallet, const CWalletTx& wtx)
{
    ...
    if (wtx.IsCoinStake()) {
        ...
        if (wtx.IsZerocoinSpend() && (fZSpendFromMe || wallet->zoztgTracker->HasMintTx(hash))) {
            //zOZTG stake reward
            sub.involvesWatchAddress = false;
            sub.type = TransactionRecord::StakeZOZTG;
...
bool IsZOZTGType(TransactionRecord::Type type)
{
    switch (type) {
        case TransactionRecord::StakeZOZTG:
...
void TransactionRecord::updateStatus(const CWalletTx& wtx)
{
    ...
    else if (type == TransactionRecord::Generated || type == TransactionRecord::StakeMint || type == TransactionRecord::StakeZOZTG || type == TransactionRecord::MNReward) {
