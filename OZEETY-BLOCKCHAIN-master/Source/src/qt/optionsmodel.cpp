...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizeozeetyAmount"))
        settings.setValue("nAnonymizeozeetyAmount", 1000);

    nAnonymizeozeetyAmount = settings.value("nAnonymizeozeetyAmount").toLongLong();
...
QVariant OptionsModel::data(const QModelIndex& index, int role) const
{
    if (role == Qt::EditRole) {
        ...
        case AnonymizeozeetyAmount:
            return QVariant(nAnonymizeozeetyAmount);
        case Listen:
...
bool OptionsModel::setData(const QModelIndex& index, const QVariant& value, int role)
{
    ...
    if (role == Qt::EditRole) {
        ...
        case AnonymizeozeetyAmount:
            nAnonymizeozeetyAmount = value.toInt();
            settings.setValue("nAnonymizeozeetyAmount", nAnonymizeozeetyAmount);
            emit anonymizeozeetyAmountChanged(nAnonymizeozeetyAmount);
            break;
        case CoinControlFeatures:
