...
void setupAddressWidget(QValidatedLineEdit* widget, QWidget* parent)
{
    ...
    widget->setPlaceholderText(QObject::tr("Enter a ozeety address (e.g. %1)").arg("X7VFR83SQbiezrW72hjcWJtcfip5krte2Z"));
#endif
...
void openConfigfile()
{
    ...
    /* Open ozeety.conf with the associated application */
