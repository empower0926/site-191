                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzOZTGPathCustom = GetArg("-zoztgbackuppath", "");
    ...
    if(!strzOZTGPathCustom.empty()) {
        ui->wallet_customzoztgbackuppath->setText(QString::fromStdString(strzOZTGPathCustom));
        ui->wallet_customzoztgbackuppath_label->setVisible(true);
        ui->wallet_customzoztgbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzOZTGPathCustom.empty()) && nCustomBackupThreshold > 0) {
