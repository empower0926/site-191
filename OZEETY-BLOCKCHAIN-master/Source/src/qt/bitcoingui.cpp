                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("ozeety Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ozeety address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and ozeety: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zOZTG"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About ozeety Core"), this);
    aboutAction->setStatusTip(tr("Show information about ozeety Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for ozeety"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ozeety addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ozeety addresses"));
    ...
    openAction->setStatusTip(tr("Open a ozeety: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the ozeety Core help message to get a list with possible ozeety command-line options"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ozeety network", "", count));
}
